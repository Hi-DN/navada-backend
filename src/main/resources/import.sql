...
INSERT INTO user(user_id,user_name,user_email,user_password,user_phone_num,user_address,user_level, user_nickname) VALUES (2,'lee','lee@naver.com','lee','010-1111-3333','address','LV1_OUTSIDER', '나는스벅나는스벅나는스벅나는스벅나는스벅나는스벅');
...
INSERT INTO product(created_date,product_id,user_id,product_name,product_explanation,category_id,product_status_cd,heart_num, product_cost, exchange_cost_range,user_nickname) VALUES (now(),1,1,'투썸아아 투썸아아 투썸아아 투썸아아 ','투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다투썸 아아입니다ㅇㅇㅇㅇ',1,0,3, 4500, 500,'투썸러버');
...
INSERT INTO product(created_date,product_id,user_id,product_name,product_explanation,category_id,product_status_cd,heart_num, product_cost, exchange_cost_range,user_nickname) VALUES (now(),4,2,'스타벅스 아이스 아메리카노 스타벅스아','스벅 아아입니다 시원한 스벅아아 드실분분분 스벅 아아입니다 시원한 스벅아아 드실분분분 스벅 아아입니다 시원한 스벅아아 드실분분분 스벅 아아입니다 시원한 스벅아아 드실분분분 구해여어',1,0,5, 4100, 1000,'나는스벅');
