...
INSERT INTO product(created_date,product_id,user_id,product_name,product_explanation,category_id,product_exchange_status_cd,heart_num, product_cost, exchange_cost_range,user_nickname) VALUES (now(),6,2,'스타벅스 바닐라라떼','스타벅스 바닐라라떼 설명~~',1,'1',0, 6000, 1000,'나는스벅나는스벅나는');
...
INSERT INTO product(created_date,product_id,user_id,product_name,product_explanation,category_id,product_exchange_status_cd,heart_num, product_cost, exchange_cost_range,user_nickname) VALUES (now(),9,3,'할리스 바닐라라떼','할리스 바닐라라떼입니다',1,'1',0, 6000, 1000,'seller');
